...
import com.mongodb.kafka.connect.sink.cdc.mongodb_bob.operations.Delete;
import com.mongodb.kafka.connect.sink.cdc.mongodb_bob.operations.Replace;
import com.mongodb.kafka.connect.sink.cdc.mongodb_bob.operations.Update;
...
public final class MongoDBBOBCdcHandler extends CdcHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MongoDBBOBCdcHandler.class);

    public MongoDBBOBCdcHandler(final MongoSinkTopicConfig config) {
        super(config);
    }
